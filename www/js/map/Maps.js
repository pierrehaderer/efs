...
Maps.prototype.loadMap = function(name, stringContent) {
    ...
    canvas.setAttribute("width", Math.min(document.body.clientWidth, this.image.width));
    canvas.setAttribute("height", Math.min(document.body.clientHeight, this.image.height));
