define(['jquery'], function($) {
    ...
    class PixiContext {
        constructor() {
             ...
             */
            this.sizer = $("<div id='sizer' style='z-index:-10;position:fixed;top:0;bottom:0;left:0;right:0;'><div>");
            this.sizer.appendTo(document.body)
        }
        ...
        refreshRenderer() {
            ...
            // get size from sizer
            this.width = this.sizer.outerWidth();
            this.height = this.sizer.outerHeight();
